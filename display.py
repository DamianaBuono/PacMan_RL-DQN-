...
class Display:
    ...
    def show_Nbacche(self, n_bacche):
        """Mostra il numero di bacche mangiate"""
        n_bacche_x = WIDTH // 3
        n_bacche_text = self.font.render(f'           {n_bacche}', True, self.text_color)
        self.screen.blit(n_bacche_text, (n_bacche_x * 2, (HEIGHT + (CHAR_SIZE // 2))))
